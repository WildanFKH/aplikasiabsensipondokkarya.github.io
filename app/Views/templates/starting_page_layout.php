...
<head>
   ...
   <style>
      .bg {
         background: url(<?= base_url('public/assets/img/bg2.jpeg'); ?>) center;
         opacity: 0.5;
      ...
      video#previewKamera {
         width: 100%; /* Ganti dengan lebar yang Anda inginkan */
         height: auto; /* Ganti dengan tinggi yang Anda inginkan */
      }
