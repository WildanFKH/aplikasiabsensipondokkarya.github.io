...
?>
<div class="sidebar" data-color="<?= $sidebarColor; ?>" data-background-color="black" data-image="<?= base_url('public/assets/img/sidebar.jpg'); ?>">
   <!--
   ...
   <a class="simple-text logo-normal">
      <img src="<?= base_url('public/assets/img/logo_dashboard.png'); ?>" alt="Logo Sekolah">
   </a>
</div>
